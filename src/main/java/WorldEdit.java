...
public class WorldEdit extends Plugin {
    ...
    /**
     * The event listener for WorldEdit on CanaryMod. Configuration and
     * such is also loaded here as well, although the core of the WorldEdit
     * is actually in com.sk89q.worldedit.WorldEditController and is merely
